...
class WBB4_Converter_Module_Privatemessages extends Converter_Module_Privatemessages
{
    ...
    function import()
    {
        ...
        $query = $this->old_db->query(
            "SELECT m.*, c.subject, c.isDraft, c.draftData
    ...
    function convert_data($data)
    {
        ...
        $insert_data['message'] = encode_to_utf8(
            ...
            WCF_PREFIX . "conversation_message",
            "privatemessages"
        );
        ...
        if ($data['isDraft']) {
            ...
            $rec_query = $this->old_db->simple_select(
                WCF_PREFIX . "conversation_to_user",
                "*",
                "conversationID='{$data['conversationID']}' AND participantID!='{$data['userID']}'"
            );
