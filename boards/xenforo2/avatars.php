...
class XENFORO2_Converter_Module_Avatars extends Converter_Module_Avatars
{
    ...
    function convert_data(array $data): array
    {
        ...
        if (!empty($data['gravatar'])) {
            ...
            $insert_data['avatar'] = $this->get_upload_avatar_name(
                $insert_data['uid'],
                $this->generate_raw_filename($data)
            );
    ...
    function generate_raw_filename($avatar): bool|string
    {
