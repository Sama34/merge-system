...
class XENFORO2_Converter_Module_Posts extends Converter_Module_Posts
{
    ...
    function import(): void
    {
        ...
        $query = $this->old_db->query(
            "SELECT p.*, t.node_id, t.title, i.ip
    ...
    function convert_data(array $data): array
    {
        ...
        $insert_data['username'] = $this->get_import->username(
            $insert_data['import_uid'],
            encode_to_utf8($data['username'], "post", "posts")
        );
        ...
        if ($data['discussion_state'] == "deleted") {
            ...
            if ($data['discussion_state'] == "moderated") {
