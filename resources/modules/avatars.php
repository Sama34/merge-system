...
abstract class Converter_Module_Avatars extends Converter_Module
{
    ...
    public function test_readability()
    {
        ...
        if (strpos($import_session['avatarspath'], '../') !== false || my_substr(
                $import_session['avatarspath'],
                0,
                1
            ) == '/' || my_substr($import_session['avatarspath'], 1, 1) == ':') {
    ...
    function get_file_data($unconverted_data)
    {
        ...
        return merge_fetch_remote_file(
            $import_session['avatarspath'] . $this->generate_raw_filename($unconverted_data)
        );
    }
